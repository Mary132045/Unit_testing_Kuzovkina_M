...
import main.java.seminars.seminar_02.Cart;
...
*/
    ...
    void priceCartIsCorrectCalculated() {
        ...
        // Assert (Проверка на утверждения)
    ...
    void priceCartProductsSameTypeIsCorrectCalculated() {
        ...
        cart.addProductToCartByID(2); // 250 +
        cart.addProductToCartByID(2); // 250 +
        cart.addProductToCartByID(2); // 250 = 1850
        // Assert (Проверка на утверждения)
        assertThat(cart.getTotalPrice()).isEqualTo(1850);
    }
    ...
    void whenChangingCartCostRecalculationIsCalled() {
        ...
        cart.removeProductByID(2); // -250 =
        // Assert (Проверка на утверждения)
        assertThat(cart.getTotalPrice()).isEqualTo(1430);
    }
    ...
    void quantityProductsStoreChanging() {
        ...
        assertThat(shop.getProductsShop().get(1).getQuantity()).isEqualTo(6);
    }
    ...
    void lastProductsDisappearFromStore() {
        ...
        Cart cart = new Cart(shop);
        // Act (Выполнение)
        cart.addProductToCartByID(1); // - 1 товар из магазина
        cart.addProductToCartByID(1); // - 1 товар из магазина
        cart.addProductToCartByID(1); // - 1 товар из магазина
        cart.addProductToCartByID(1); // - 1 товар из магазина
        cart.addProductToCartByID(1); // - 1 товар из магазина
        ...
        cart.addProductToCartByID(1); // - 1 товар из магазина
        cart.addProductToCartByID(1); // - 1 товар из магазина
        cart.addProductToCartByID(1); // - 1 товар из магазина (последний)
        cart.addProductToCartByID(1); // - Этого товара нет в наличии
        // Assert (Проверка на утверждения)
    ...
    void deletedProductIsReturnedToShop() {
        ...
        cart.addProductToCartByID(1); // - 1 товар из магазина
        cart.addProductToCartByID(1); // - 1 товар из магазина (последний)
        cart.removeProductByID(1); // + 1 товар
        cart.removeProductByID(1); // + 1 товар
        // Assert (Проверка на утверждения)
