package seminars.seminar_04.card;

import main.java.seminars.seminar_04.card.CreditCard;
import main.java.seminars.seminar_04.card.PaymentForm;
...
class PaymentFormTest {
    ...
    public void testPaymentForm() {
        ...
        // Определение поведения класса PaymentForm, передача ему мок-объекта в качестве аргумента
        ...
        // Создание объекта класса PaymentForm и передача ему мок-объекта в качестве аргумента
